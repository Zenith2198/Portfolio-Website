				...
				{userId ?
					<div>
						<div className="form-control w-full max-w-xs">
							...
							<input name="name" onChange={handleTitle} autoComplete="new-name" type="text" placeholder="Enter new user name" className="input input-bordered w-full max-w-xs"/>
						</div>
						<div className="form-control w-full max-w-xs">
							<label className="label">
							...
							<input name="password" id="editUserPassword" onChange={handlePassword} autoComplete="new-password" type="password" placeholder="Enter new password" className="input input-bordered w-full max-w-xs"/>
						</div>
						<div className="form-control w-full max-w-xs">
							<label className="label">
								<span className="label-text">Retype Password</span>
							</label>
							<input name="retypePassword" id="editUserRetypePassword" onChange={handlePassword} autoComplete="new-password" type="password" placeholder="Retype password" className="input input-bordered w-full max-w-xs"/>
						</div>
